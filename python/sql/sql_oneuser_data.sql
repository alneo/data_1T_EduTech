--это код для вебки. При запуске запрашивается user_id, вводишь номер и получаешь датасет для входа в модель, состоящий из одной строки - информации по одному юзеру
