...
course_progress2 course_progress2
from metrics_2 m2
...
from dt where k_day < current_date
				and user_id in(select distinct user_id from dt where k_day = current_date and abs(current_progress - course_progress2) <= 10)
)
